      ...
      <div className="flex shadow-md my-10">
        <div className="w-3/4 bg-white px-10 py-10">
          ...
          <div className="flex mt-10 mb-5">
            ...
            <h3 className="font-semibold text-center  text-gray-600 text-xL uppercase w-1/5">Quantity</h3>
            <h3 className="font-semibold text-center text-gray-600 text-xL uppercase w-1/5">Price</h3>
            <h3 className="font-semibold text-center text-gray-600 text-xL uppercase w-1/5">Total</h3>
          </div>
          {
            carts?.map(cart => {
              return (
                <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                  <div className="flex w-2/5">
                    ...
                    <div className="flex flex-col justify-between ml-4 flex-grow">
                      ...
                      <span className="text-red-500 text-xL capitalize">{cart?.category}</span>
                      <div className="font-semibold hover:text-red-500 text-gray-500 text-xL cursor-pointer" onClick={() => removeProduct(cart?.id)}>Remove</div>
                    </div>
                  </div>
